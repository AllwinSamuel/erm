(function () {
    if (window.lyteDomObj) {
        window.lyteDomObj.prototype.readingMask = function (params) {
            var element = this[0];
            ...
            if (params !== "destroy") {
                ...
                function setInitialMaskDim(params){
                        if (params && params.maskWidth) {
                            if (typeof params.maskWidth === "number") {
                                window.maskWidth = params.maskWidth + "px";
                            }
                            else { window.maskWidth = params.maskWidth; }
                        } else { window.maskWidth = "500px"; }

                        if (params && params.maskHeight) {
                            if (typeof params.maskHeight === "number") {
                                window.maskHeight = params.maskHeight + "px";
                            }
                            else { window.maskHeight = params.maskHeight; }
                        } else { window.maskHeight = "100px"; }

                        if (params && params.freezeLayerColor) {
                            window.freezeLayerColor = params.freezeLayerColor;
                        } else { window.freezeLayerColor = "black" }

                        if (params && params.freezeLayerOpacity) {
                            window.freezeLayerOpacity = params.freezeLayerOpacity;
                        } else { window.freezeLayerOpacity = "0.5" }
                }
                ...
                window.maskarea.remove();
                window.freeze.remove();
