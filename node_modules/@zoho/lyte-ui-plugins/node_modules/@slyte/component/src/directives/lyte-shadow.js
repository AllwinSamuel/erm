...
class Shadow extends Service{
    ...
    static register(){
        ComponentRegistry._addShadow(this);
    }
    // registryInstantiation(registryInstance){
    //     var shadow = this;
    //     _LC.appendChild = function(){
    //         let registryIns = this;
    //         var argumentsArr = Array.from(arguments);
    ...
    getShadowParent(shadowParent,directiveObj){
        while(shadowParent){
            ...
            if(shadowParent && hostEleParent && hostEleParent.tagName != "SHADOW-WRAPPER"){
                ...
                var shadowDeep = directiveObj.getTransitionArg(hostEleParent,"shadow-deep");
                break;
            }
    ...
    inlineStyle(node,shadow,directiveObj){
        // let directiveObj = node.getDirectiveObj();
        let stryleArg = directiveObj.getTransitionArg(node,"shadow-style");
    ...
    newShadowComp(comp,shadowParent){
        ...
        if(shadowParent && directiveObj.getTransitionArg(comp,"shadow-deep") == undefined && directiveObj.getTransitionAttr(pNode,"shadow-deep") ){
            if(!comp._specialAttributeDetails){
