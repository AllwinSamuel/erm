...
function cloneMatchedObj(matched, data) {
	return {
		...matched,
		route : data.route || Array.from(matched.route),
		dynamicParams : data.dynamicParams || Array.from(matched.dynamicParams),
		queryParams : data.queryParams || { ...matched.queryParams }
	}
