(function () {
  if (window.lyteDomObj) {
    window.lyteDomObj.prototype.infiniteScroll = function (param) {
      var table = this[0];
      ...
      table.addEventListener('scroll', function (e) {
        ...
        if (isSafari && once) {
          ...
          window.parentNode = $L(table).find('tr')[0].parentNode;
        ...
        if (currentScroll >= 0) {
          ...
          // if Scroll Up happens
            ...
            window.diff = Math.max(Math.abs(difference) / rowHeight, 1);
