...
.lyteCalTableRowGroup .lyteWeekNumberGrid {
	...
	padding-right: map.get($lyteWeekNumberGridMap, "padding-right");
...
.lyteWeekNumContainer .lyteCalTableContainer::before {
    ...
    left: map.get($lyteWeekNumContainerTableContainerBeforeMap, "left");
	display: inline-block;
...
.lyteCalTableCellHeader.lyteWeekNumberGrid {
	padding-right: map.get($lyteCalTableCellHeaderWeekNumGridMap, "padding-right");
