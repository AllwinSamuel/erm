import { defineRelation, triggerEvent, isEntity, extendEventListeners, getConfig, addEventListener, removeEventListener, copyObject, defProps, globalsSet, globalsGet, /*,type, prop, addToInstance*/set,get, arrayUtils, objectUtils,_lyteInit,_lyteDidConnect} from '@slyte/core/src/lyte-utils.js';
...
class Lyte { 
  ...
  constructor(config) {
    ...
    this.addEventListener("transitionStart",function(obj){
    ...
    this.addEventListener("beforeRouteTransition", function(obj){
...
Lyte.prototype.getConfig = getConfig;
