...
class GraphqlConnector extends Connector{
    ...
    static get(db, type, def, key, queryParams, cacheQuery, customData, cacheData, unload, forceFetch, opName, gqlVar){
        ...
        if(mdl || ( typeof mdl == "string"  && defless === true)){
            ...
            var urlObj = this.buildURL(db, type, "GET", def, key, undefined, queryParams,undefined,customData,undefined,argsObj,gqlEnables), 
            self = this,
    ...
    static put(db, name, data, record, isSingleRecord,customData, qP, mutationName){
        ...
        return this.handleRequest(db, urlObj, name, record, type, updatedData, customData, partial.obj,undefined, undefined, partial.ref, argsObj);
    }
