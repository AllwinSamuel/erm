...
import { establishObjectBinding, establishObserverBindings, extendEventListeners, isInheritedClass } from "@slyte/core/src/lyte-utils.js";
...
class Schema{
    ...
    static create(db, lIns){
        ...
        _this._properties = {};
        _this._fldGrps = { default : {}, hasMany: {}, watch: {}, inherit:{} ,nested_prop: {}, reverseKey: new Map() };
        _this.data = [];
        _this.dirty = [];
