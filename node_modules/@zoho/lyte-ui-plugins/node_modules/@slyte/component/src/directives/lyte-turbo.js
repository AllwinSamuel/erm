...
class Turbo extends Service{
    static register(){
        ComponentRegistry._addFastRender(this);
    }
    ...
    renderFast(dynamicNodes, arr, comp, compPreDef, self) {
        if(!arr){
            Lyte.error(comp.$node.localName+" component not supporting fast render. please add @unbound-supported in the component's template tag.");
            return "";
        }
        var fastRenderIndex;
        var prevComp;
