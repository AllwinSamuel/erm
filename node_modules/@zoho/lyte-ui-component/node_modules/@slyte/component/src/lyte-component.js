...
//                    }
    ...
    "render" : function(componentName, data, outlet, _lyteOptions) {
        ...
        if(Lyte.Compatibility.vue){
            Lyte.Compatibility.vue.renderYield(_lyteOptions, component);
        }
    ...
    actualConnectedCallback(){
        ...
        if( !this.hasAttribute( "server-rendered" ) || this.serverCall ||  _config_flag ){
            if( _overrides && _overrides.didConnect && this.serverCall ){
                ...
                if(Lyte.Compatibility.vue && this.__delayDidConnect){
...
defHelpers["unescape"] = function(value,additionalObject,userInstance,options){
    ...
    if(options && options.ignoreSanitizer){
        ...
        let clean;
        if(!Security._ourSanitizerInstance_){
            let sec = { "GLOBAL_TAGS": [], "GLOBAL_ATTRIBUTES": [],"FORBID_TAGS":[],"FORBID_ATTR":[] , REUSE_CONFIG : true};
            Security._ourSanitizerInstance_ = new Sanitizer(sec)._sanitzer;
        }
        let ins = userInstance && Object.keys(userInstance).length ? userInstance._sanitzer : Security._ourSanitizerInstance_;
...
Lyte.Compatibility.vue = {
    ...
    updateYield : function(comp, node){
        if(node._callee._dynYields){
            let dynamicToAppend = node._callee._dynYields[comp.getYieldName(node)];
            if(dynamicToAppend){
...
export {ComponentRegistry,Component,RawComponent,Helper,arrayUtils,objectUtils,set,appendChild,insertAfter,insertBeforeFn as insertBefore,replaceWith,shouldIgnoreDisconnect,defProp,render,_LC,customElementPrototype,LyteCustomElement,getNearestApp,_addLyteAction};
